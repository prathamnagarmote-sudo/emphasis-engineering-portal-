      ...
      <div className="max-w-7xl mx-auto px-6 pb-32">
        <div className="flex flex-col lg:flex-row gap-12 xl:gap-20 relative">
          ...
          <article className="flex-1 min-w-0">
            <div 
              className="prose prose-lg prose-slate max-w-none prose-headings:text-[#061F33] prose-headings:font-bold prose-p:text-gray-600 prose-p:leading-[1.8] prose-strong:text-[#061F33] prose-a:text-[#3F9FA3] prose-a:no-underline hover:prose-a:underline blog-content break-words"
            ...
            <div className="mt-20 p-6 sm:p-10 bg-gray-50 rounded-[2.5rem] flex flex-col sm:flex-row items-center gap-8 border border-gray-100">
              <div className="w-24 h-24 rounded-3xl bg-[#061F33] flex items-center justify-center text-white text-3xl font-bold shadow-xl shrink-0">{blog.author.charAt(0)}</div>
              <div className="text-center sm:text-left">
                ...
                <p className="text-gray-500 leading-relaxed text-sm">An experienced professional with deep expertise in {blog.service} certification pathways and engineering excellence.</p>
              </div>
            </div>
          </article>
